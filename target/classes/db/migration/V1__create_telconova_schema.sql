...
('ORD-2025-007', 'Reparación Módem Cliente', 'Reparación de módem ADSL cliente residencial', 'ASIGNADA', 'MEDIA', 'REPARACION', 'Darwin Andrés Tangarife Avendaño', '+573015781171', 'Calle 45 #70-12, Belén, Medellín', 3, CURRENT_TIMESTAMP - INTERVAL '30 minutes',null, CURRENT_TIMESTAMP - INTERVAL '1 hour'),
('ORD-2025-008', 'Instalación WiFi Empresa', 'Instalación de red WiFi empresarial en oficina nueva', 'ASIGNADA', 'ALTA', 'INSTALACION', 'Johana Liseth Sevillano Herrera', '+573196960915', 'Carrera 48 #26-85, La Candelaria, Medellín', 4, CURRENT_TIMESTAMP - INTERVAL '2 hours',null, CURRENT_TIMESTAMP - INTERVAL '3 hours'),
('ORD-2025-009', 'Mantenimiento Switch Central', 'Mantenimiento correctivo de switch en central telefónica', 'ASIGNADA', 'CRITICA', 'MANTENIMIENTO', 'Central Telefónica Norte', '+573145287825', 'Carrera 52 #67-30, Aranjuez, Medellín', 5, CURRENT_TIMESTAMP - INTERVAL '45 minutes',null, CURRENT_TIMESTAMP - INTERVAL '1 hour 30 minutes'),
('ORD-2025-010', 'Upgrade Fibra Óptica', 'Migración de ADSL a fibra óptica cliente empresarial', 'ASIGNADA', 'ALTA', 'UPGRADE', 'Consultoría Jurídica ABC', '+573142562324', 'Calle 10A Sur #43-50, El Poblado, Medellín', 6, CURRENT_TIMESTAMP - INTERVAL '20 minutes',null, CURRENT_TIMESTAMP - INTERVAL '40 minutes'),
('ORD-2025-011', 'Instalación CCTV IP', 'Instalación de sistema de cámaras IP sobre red existente', 'ASIGNADA', 'MEDIA', 'INSTALACION', 'Supermercado La Economía', '+573012506677', 'Carrera 65 #48-20, Buenos Aires, Medellín', 7, CURRENT_TIMESTAMP - INTERVAL '1 hour 15 minutes',null, CURRENT_TIMESTAMP - INTERVAL '2 hours 30 minutes'),
('ORD-2025-012', 'Reparación Antena WiFi', 'Reparación de antena WiFi exterior dañada por tormenta', 'ASIGNADA', 'ALTA', 'REPARACION', 'Finca Villa Hermosa', '+573005554433', 'Vereda La Madera, La Estrella, Antioquia', 8, CURRENT_TIMESTAMP - INTERVAL '3 hours',null, CURRENT_TIMESTAMP - INTERVAL '4 hours'),
('ORD-2025-013', 'Instalación Red Colegio', 'Instalación de red de datos en aulas de sistemas', 'ASIGNADA', 'MEDIA', 'INSTALACION', 'Colegio San José de Las Vegas', '+573145389900', 'Calle 25 Sur #55-30, Las Vegas, Medellín', 9, CURRENT_TIMESTAMP - INTERVAL '2 hours 30 minutes',null, CURRENT_TIMESTAMP - INTERVAL '3 hours 45 minutes'),
('ORD-2025-014', 'Mantenimiento Rack Datos', 'Mantenimiento preventivo de rack de datos en oficina principal', 'ASIGNADA', 'MEDIA', 'MANTENIMIENTO', 'Constructora Andina Ltda', '+573144442211', 'Carrera 50 #60-40, Centro, Medellín', 10, CURRENT_TIMESTAMP - INTERVAL '4 hours',null, CURRENT_TIMESTAMP - INTERVAL '5 hours'),
('ORD-2025-015', 'Reparación Fibra Cortada', 'Reparación de fibra óptica cortada por obras civiles', 'ASIGNADA', 'CRITICA', 'REPARACION', 'Conjunto Residencial Torres del Sol', '+573144448877', 'Carrera 70 #80-50, Robledo, Medellín', 11, CURRENT_TIMESTAMP - INTERVAL '1 hour 45 minutes',null, CURRENT_TIMESTAMP - INTERVAL '2 hours 15 minutes'),
...
('ORD-2025-017', 'Upgrade Router Empresarial', 'Actualización de router empresarial por obsolescencia', 'ASIGNADA', 'ALTA', 'UPGRADE', 'Laboratorio Clínico Salud Total', '+573143505566', 'Carrera 43A #5A-113, El Poblado, Medellín', 3, CURRENT_TIMESTAMP - INTERVAL '3 hours 20 minutes',null, CURRENT_TIMESTAMP - INTERVAL '4 hours 30 minutes'),
('ORD-2025-018', 'Instalación VPN Empresarial', 'Configuración de VPN para trabajo remoto', 'ASIGNADA', 'ALTA', 'INSTALACION', 'Agencia de Viajes Mundo Tour', '+573142503344', 'Calle 70 #52-20, Manrique, Medellín', 4, CURRENT_TIMESTAMP - INTERVAL '5 hours 30 minutes',null, CURRENT_TIMESTAMP - INTERVAL '6 hours'),
('ORD-2025-019', 'Reparación Switch PoE', 'Reparación de switch PoE que no alimenta cámaras IP', 'ASIGNADA', 'MEDIA', 'REPARACION', 'Centro Comercial Plaza Mayor', '+573144449955', 'Carrera 65 #50-30, Candelaria, Medellín', 5, CURRENT_TIMESTAMP - INTERVAL '2 hours 45 minutes', null, CURRENT_TIMESTAMP - INTERVAL '3 hours 30 minutes'),
...
('ORD-2025-021', 'Mantenimiento Antenas', 'Mantenimiento preventivo de antenas en azotea', 'ASIGNADA', 'MEDIA', 'MANTENIMIENTO', 'Hospital General del Norte', '+573144446677', 'Calle 67 #52-44, Bello, Antioquia', 7, CURRENT_TIMESTAMP - INTERVAL '4 hours 15 minutes', null, CURRENT_TIMESTAMP - INTERVAL '5 hours 30 minutes'),
('ORD-2025-022', 'Reparación Conexión ADSL', 'Reparación de línea ADSL con baja velocidad', 'ASIGNADA', 'MEDIA', 'REPARACION', 'Panadería y Repostería El Horno', '+573004445566', 'Carrera 45 #32-10, Villa Hermosa, Medellín', 8, CURRENT_TIMESTAMP - INTERVAL '6 hours', null, CURRENT_TIMESTAMP - INTERVAL '7 hours'),
