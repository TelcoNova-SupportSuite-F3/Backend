...
INSERT INTO usuarios (email, contrasena, nombre_completo, rol, activo) VALUES
-- ADMINISTRADOR
('admin@telconova.com', '$2a$12$pUdXswO30S7CEG4.LP9eQetRvr2HsyBI2qlhu1mM8pguhb9tjFvhK', 'Carlos Eduardo Administrador', 'ADMIN', true),

-- TÉCNICOS (10)
('juan.perez@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Juan Carlos Pérez González', 'TECNICO', true),
('maria.rodriguez@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'María Fernanda Rodríguez López', 'TECNICO', true),
('carlos.martinez@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Carlos Andrés Martínez Silva', 'TECNICO', true),
('ana.garcia@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Ana Lucía García Ruiz', 'TECNICO', true),
('luis.hernandez@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Luis Fernando Hernández Castro', 'TECNICO', true),
('sofia.lopez@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Sofía Alejandra López Moreno', 'TECNICO', true),
('diego.torres@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Diego Alexander Torres Vega', 'TECNICO', true),
('elena.jimenez@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Elena Patricia Jiménez Díaz', 'TECNICO', true),
('andres.vargas@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Andrés Felipe Vargas Romero', 'TECNICO', true),
('gabriela.morales@telconova.com', '$2a$12$MuHsZsuhjv7oTh/bw2SnrO9hafxfFpzc/lwszUtq4oy7cEAEDN1BO', 'Gabriela Isabel Morales Sánchez', 'TECNICO', true);

-- =====================================================
-- MATERIALES: 100 MATERIALES DE TELECOMUNICACIONES
-- =====================================================
...
INSERT INTO ordenes_trabajo (numero_orden, titulo, descripcion, estado, prioridad, tipo_servicio, cliente_nombre, cliente_telefono, direccion, tecnico_asignado_id, fecha_asignacion, fecha_creacion) VALUES

-- 5 ÓRDENES EN_PROCESO
('ORD-2025-001', 'Instalación Fibra Óptica Residencial', 'Instalación de fibra óptica 200Mbps para cliente residencial en Laureles', 'EN_PROCESO', 'ALTA', 'INSTALACION', 'Sandra Milena Gómez', '+57 304 567 8901', 'Carrera 75 #45-89, Laureles, Medellín', 2, CURRENT_TIMESTAMP - INTERVAL '3 hours', CURRENT_TIMESTAMP - INTERVAL '1 day'),
('ORD-2025-002', 'Reparación Conectividad Empresarial', 'Reparación de conectividad de internet empresarial - falla intermitente', 'EN_PROCESO', 'CRITICA', 'REPARACION', 'Empresa Logística Express SAS', '+57 4 444 5566', 'Calle 30 Sur #48-25, Envigado', 3, CURRENT_TIMESTAMP - INTERVAL '2 hours', CURRENT_TIMESTAMP - INTERVAL '1 day'),
('ORD-2025-003', 'Upgrade Red WiFi Corporativa', 'Actualización de red WiFi corporativa a WiFi 6 en edificio de oficinas', 'EN_PROCESO', 'MEDIA', 'UPGRADE', 'Consultores Estratégicos Ltda', '+57 4 350 7788', 'Carrera 43A #16-30, El Poblado, Medellín', 4, CURRENT_TIMESTAMP - INTERVAL '4 hours', CURRENT_TIMESTAMP - INTERVAL '2 days'),
('ORD-2025-004', 'Mantenimiento Preventivo Torres', 'Mantenimiento preventivo en torre de telecomunicaciones sector norte', 'EN_PROCESO', 'MEDIA', 'MANTENIMIENTO', 'TelcoNova Colombia SAS', '+57 4 444 1234', 'Calle 67 #52-20, Bello, Antioquia', 5, CURRENT_TIMESTAMP - INTERVAL '1 hour', CURRENT_TIMESTAMP - INTERVAL '3 days'),
('ORD-2025-005', 'Instalación Red Punto Venta', 'Instalación de red para nuevos puntos de venta en centro comercial', 'EN_PROCESO', 'ALTA', 'INSTALACION', 'Tiendas D1 Colombia', '+57 4 500 2233', 'Carrera 65 #33-10, Centro, Medellín', 6, CURRENT_TIMESTAMP - INTERVAL '5 hours', CURRENT_TIMESTAMP - INTERVAL '2 days'),

-- 25 ÓRDENES ASIGNADAS
('ORD-2025-006', 'Instalación Internet Hogar', 'Instalación de internet residencial 100Mbps', 'ASIGNADA', 'MEDIA', 'INSTALACION', 'Carlos Andrés Muñoz', '+57 301 234 5678', 'Carrera 80 #32-45, Robledo, Medellín', 2, CURRENT_TIMESTAMP - INTERVAL '1 hour', CURRENT_TIMESTAMP - INTERVAL '2 hours'),
('ORD-2025-007', 'Reparación Módem Cliente', 'Reparación de módem ADSL cliente residencial', 'ASIGNADA', 'MEDIA', 'REPARACION', 'María Elena Vargas', '+57 300 987 6543', 'Calle 45 #70-12, Belén, Medellín', 3, CURRENT_TIMESTAMP - INTERVAL '30 minutes', CURRENT_TIMESTAMP - INTERVAL '1 hour'),
('ORD-2025-008', 'Instalación WiFi Empresa', 'Instalación de red WiFi empresarial en oficina nueva', 'ASIGNADA', 'ALTA', 'INSTALACION', 'Diseños Arquitectónicos SAS', '+57 4 260 5050', 'Carrera 48 #26-85, La Candelaria, Medellín', 4, CURRENT_TIMESTAMP - INTERVAL '2 hours', CURRENT_TIMESTAMP - INTERVAL '3 hours'),
('ORD-2025-009', 'Mantenimiento Switch Central', 'Mantenimiento correctivo de switch en central telefónica', 'ASIGNADA', 'CRITICA', 'MANTENIMIENTO', 'Central Telefónica Norte', '+57 4 444 7890', 'Carrera 52 #67-30, Aranjuez, Medellín', 5, CURRENT_TIMESTAMP - INTERVAL '45 minutes', CURRENT_TIMESTAMP - INTERVAL '1 hour 30 minutes'),
('ORD-2025-010', 'Upgrade Fibra Óptica', 'Migración de ADSL a fibra óptica cliente empresarial', 'ASIGNADA', 'ALTA', 'UPGRADE', 'Consultoría Jurídica ABC', '+57 4 350 4455', 'Calle 10A Sur #43-50, El Poblado, Medellín', 6, CURRENT_TIMESTAMP - INTERVAL '20 minutes', CURRENT_TIMESTAMP - INTERVAL '40 minutes'),
('ORD-2025-011', 'Instalación CCTV IP', 'Instalación de sistema de cámaras IP sobre red existente', 'ASIGNADA', 'MEDIA', 'INSTALACION', 'Supermercado La Economía', '+57 4 250 6677', 'Carrera 65 #48-20, Buenos Aires, Medellín', 7, CURRENT_TIMESTAMP - INTERVAL '1 hour 15 minutes', CURRENT_TIMESTAMP - INTERVAL '2 hours 30 minutes'),
('ORD-2025-012', 'Reparación Antena WiFi', 'Reparación de antena WiFi exterior dañada por tormenta', 'ASIGNADA', 'ALTA', 'REPARACION', 'Finca Villa Hermosa', '+57 300 555 4433', 'Vereda La Madera, La Estrella, Antioquia', 8, CURRENT_TIMESTAMP - INTERVAL '3 hours', CURRENT_TIMESTAMP - INTERVAL '4 hours'),
('ORD-2025-013', 'Instalación Red Colegio', 'Instalación de red de datos en aulas de sistemas', 'ASIGNADA', 'MEDIA', 'INSTALACION', 'Colegio San José de Las Vegas', '+57 4 538 9900', 'Calle 25 Sur #55-30, Las Vegas, Medellín', 9, CURRENT_TIMESTAMP - INTERVAL '2 hours 30 minutes', CURRENT_TIMESTAMP - INTERVAL '3 hours 45 minutes'),
('ORD-2025-014', 'Mantenimiento Rack Datos', 'Mantenimiento preventivo de rack de datos en oficina principal', 'ASIGNADA', 'MEDIA', 'MANTENIMIENTO', 'Constructora Andina Ltda', '+57 4 444 2211', 'Carrera 50 #60-40, Centro, Medellín', 10, CURRENT_TIMESTAMP - INTERVAL '4 hours', CURRENT_TIMESTAMP - INTERVAL '5 hours'),
('ORD-2025-015', 'Reparación Fibra Cortada', 'Reparación de fibra óptica cortada por obras civiles', 'ASIGNADA', 'CRITICA', 'REPARACION', 'Conjunto Residencial Torres del Sol', '+57 4 444 8877', 'Carrera 70 #80-50, Robledo, Medellín', 11, CURRENT_TIMESTAMP - INTERVAL '1 hour 45 minutes', CURRENT_TIMESTAMP - INTERVAL '2 hours 15 minutes'),
('ORD-2025-016', 'Instalación Internet Café', 'Instalación de conexión de alta velocidad para café internet', 'ASIGNADA', 'MEDIA', 'INSTALACION', 'Café Internet Digital', '+57 301 777 8899', 'Calle 33 #65-12, Doce de Octubre, Medellín', 2, CURRENT_TIMESTAMP - INTERVAL '30 minutes', CURRENT_TIMESTAMP - INTERVAL '1 hour'),
('ORD-2025-017', 'Upgrade Router Empresarial', 'Actualización de router empresarial por obsolescencia', 'ASIGNADA', 'ALTA', 'UPGRADE', 'Laboratorio Clínico Salud Total', '+57 4 350 5566', 'Carrera 43A #5A-113, El Poblado, Medellín', 3, CURRENT_TIMESTAMP - INTERVAL '3 hours 20 minutes', CURRENT_TIMESTAMP - INTERVAL '4 hours 30 minutes'),
('ORD-2025-018', 'Instalación VPN Empresarial', 'Configuración de VPN para trabajo remoto', 'ASIGNADA', 'ALTA', 'INSTALACION', 'Agencia de Viajes Mundo Tour', '+57 4 250 3344', 'Calle 70 #52-20, Manrique, Medellín', 4, CURRENT_TIMESTAMP - INTERVAL '5 hours 30 minutes', CURRENT_TIMESTAMP - INTERVAL '6 hours'),
('ORD-2025-019', 'Reparación Switch PoE', 'Reparación de switch PoE que no alimenta cámaras IP', 'ASIGNADA', 'MEDIA', 'REPARACION', 'Centro Comercial Plaza Mayor', '+57 4 444 9955', 'Carrera 65 #50-30, Candelaria, Medellín', 5, CURRENT_TIMESTAMP - INTERVAL '2 hours 45 minutes', CURRENT_TIMESTAMP - INTERVAL '3 hours 30 minutes'),
('ORD-2025-020', 'Instalación Fibra Edificio', 'Cableado estructurado con fibra óptica en edificio nuevo', 'ASIGNADA', 'CRITICA', 'INSTALACION', 'Edificio Empresarial Sky Tower', '+57 4 444 1122', 'Carrera 43A #14-50, El Poblado, Medellín', 6, CURRENT_TIMESTAMP - INTERVAL '1 hour 30 minutes', CURRENT_TIMESTAMP - INTERVAL '2 hours 45 minutes'),
('ORD-2025-021', 'Mantenimiento Antenas', 'Mantenimiento preventivo de antenas en azotea', 'ASIGNADA', 'MEDIA', 'MANTENIMIENTO', 'Hospital General del Norte', '+57 4 444 6677', 'Calle 67 #52-44, Bello, Antioquia', 7, CURRENT_TIMESTAMP - INTERVAL '4 hours 15 minutes', CURRENT_TIMESTAMP - INTERVAL '5 hours 30 minutes'),
('ORD-2025-022', 'Reparación Conexión ADSL', 'Reparación de línea ADSL con baja velocidad', 'ASIGNADA', 'MEDIA', 'REPARACION', 'Panadería y Repostería El Horno', '+57 300 444 5566', 'Carrera 45 #32-10, Villa Hermosa, Medellín', 8, CURRENT_TIMESTAMP - INTERVAL '6 hours', CURRENT_TIMESTAMP - INTERVAL '7 hours'),
('ORD-2025-023', 'Instalación Red Restaurante', 'Instalación de red WiFi y cableado para sistema POS', 'ASIGNADA', 'ALTA', 'INSTALACION', 'Restaurante La Hacienda', '+57 4 350 7799', 'Calle 10 Sur #43A-50, El Poblado, Medellín', 9, CURRENT_TIMESTAMP - INTERVAL '3 hours 45 minutes', CURRENT_TIMESTAMP - INTERVAL '4 hours 15 minutes'),
('ORD-2025-024', 'Upgrade Central Telefónica', 'Actualización de central telefónica IP', 'ASIGNADA', 'CRITICA', 'UPGRADE', 'Clínica Odontológica Sonrisas', '+57 4 260 8899', 'Carrera 70 #45-30, Laureles, Medellín', 10, CURRENT_TIMESTAMP - INTERVAL '2 hours 20 minutes', CURRENT_TIMESTAMP - INTERVAL '3 hours 10 minutes'),
('ORD-2025-025', 'Instalación WiFi Hotel', 'Instalación de red WiFi de alta capacidad en hotel', 'ASIGNADA', 'ALTA', 'INSTALACION', 'Hotel Business Plaza', '+57 4 444 3366', 'Calle 50 #70-200, Estadio, Medellín', 11, CURRENT_TIMESTAMP - INTERVAL '5 hours 45 minutes', CURRENT_TIMESTAMP - INTERVAL '6 hours 30 minutes'),
('ORD-2025-026', 'Reparación Fibra Domiciliaria', 'Reparación de acometida de fibra óptica residencial', 'ASIGNADA', 'MEDIA', 'REPARACION', 'Alejandro Restrepo Cardona', '+57 304 888 7766', 'Carrera 80 #50-20, Castilla, Medellín', 2, CURRENT_TIMESTAMP - INTERVAL '1 hour 10 minutes', CURRENT_TIMESTAMP - INTERVAL '1 hour 50 minutes'),
('ORD-2025-027', 'Instalación Cámaras IP', 'Instalación de sistema de videovigilancia IP', 'ASIGNADA', 'MEDIA', 'INSTALACION', 'Farmacia Cruz Verde Sucursal 45', '+57 4 444 2255', 'Carrera 65 #35-40, Buenos Aires, Medellín', 3, CURRENT_TIMESTAMP - INTERVAL '7 hours', CURRENT_TIMESTAMP - INTERVAL '8 hours'),
('ORD-2025-028', 'Mantenimiento UPS Sala Servidores', 'Mantenimiento correctivo de UPS en sala de servidores', 'ASIGNADA', 'ALTA', 'MANTENIMIENTO', 'Banco Popular Sucursal Norte', '+57 4 444 5599', 'Calle 75 #65-30, Aranjuez, Medellín', 4, CURRENT_TIMESTAMP - INTERVAL '4 hours 30 minutes', CURRENT_TIMESTAMP - INTERVAL '5 hours 45 minutes'),
('ORD-2025-029', 'Reparación Router WiFi', 'Reparación de router WiFi empresarial con fallas de conectividad', 'ASIGNADA', 'MEDIA', 'REPARACION', 'Oficina Contable Números & Cia', '+57 4 350 4477', 'Carrera 43A #20-50, El Poblado, Medellín', 5, CURRENT_TIMESTAMP - INTERVAL '3 hours 15 minutes', CURRENT_TIMESTAMP - INTERVAL '4 hours 5 minutes'),
('ORD-2025-030', 'Instalación Red Laboratorio', 'Instalación de red de datos en laboratorio de análisis clínicos', 'ASIGNADA', 'CRITICA', 'INSTALACION', 'Laboratorio Médico Diagnósticos', '+57 4 260 7788', 'Calle 67 #48-30, Manrique, Medellín', 6, CURRENT_TIMESTAMP - INTERVAL '2 hours 10 minutes', CURRENT_TIMESTAMP - INTERVAL '2 hours 55 minutes');
...
INSERT INTO materiales_utilizados (orden_trabajo_id, material_id, cantidad_utilizada, registrado_por, fecha_registro) VALUES
(1, 4, 150, 2, CURRENT_TIMESTAMP - INTERVAL '2 hours'), -- Cable Fibra Óptica Monomodo 150m
(1, 11, 2, 2, CURRENT_TIMESTAMP - INTERVAL '2 hours'), -- Conectores SC Fibra x2
(1, 33, 1, 2, CURRENT_TIMESTAMP - INTERVAL '1 hour 30 minutes'), -- Caja Terminal Óptica
(1, 81, 1, 2, CURRENT_TIMESTAMP - INTERVAL '1 hour'), -- Caja de Distribución 12FO

-- Materiales para ORD-2025-002 (Reparación Conectividad) - María Rodríguez
(2, 24, 1, 3, CURRENT_TIMESTAMP - INTERVAL '1 hour 15 minutes'), -- Switch 24 Puertos Managed
(2, 18, 4, 3, CURRENT_TIMESTAMP - INTERVAL '1 hour'), -- Patch Cord Cat 6 - 1m x4
(2, 19, 2, 3, CURRENT_TIMESTAMP - INTERVAL '45 minutes'), -- Patch Cord Cat 6 - 3m x2
(2, 63, 1, 3, CURRENT_TIMESTAMP - INTERVAL '30 minutes'), -- UPS 650VA

-- Materiales para ORD-2025-003 (Upgrade WiFi) - Carlos Martínez
(3, 31, 8, 4, CURRENT_TIMESTAMP - INTERVAL '3 hours'), -- Punto Acceso WiFi 6 x8
(3, 33, 4, 4, CURRENT_TIMESTAMP - INTERVAL '2 hours 30 minutes'), -- Punto Acceso Mesh x4
(3, 25, 2, 4, CURRENT_TIMESTAMP - INTERVAL '2 hours'), -- Inyector PoE x2
(3, 2, 200, 4, CURRENT_TIMESTAMP - INTERVAL '1 hour 30 minutes'), -- Cable UTP Cat 6 - 200m

-- Materiales para ORD-2025-004 (Mantenimiento Torres) - Ana García
(4, 36, 2, 5, CURRENT_TIMESTAMP - INTERVAL '40 minutes'), -- Antena Omnidireccional 2.4GHz x2
(4, 73, 5, 5, CURRENT_TIMESTAMP - INTERVAL '30 minutes'), -- Desoxidante Contactos x5
(4, 74, 3, 5, CURRENT_TIMESTAMP - INTERVAL '25 minutes'), -- Limpiador Isopropílico x3
(4, 75, 2, 5, CURRENT_TIMESTAMP - INTERVAL '15 minutes'), -- Grasa Dieléctrica x2

-- Materiales para ORD-2025-005 (Red Puntos Venta) - Luis Hernández
(5, 22, 3, 6, CURRENT_TIMESTAMP - INTERVAL '4 hours'), -- Switch 8 Puertos Gigabit x3
(5, 21, 8, 6, CURRENT_TIMESTAMP - INTERVAL '3 hours 30 minutes'), -- Router WiFi 6 AX1800 x8
(5, 2, 500, 6, CURRENT_TIMESTAMP - INTERVAL '3 hours'), -- Cable UTP Cat 6 - 500m
(5, 9, 50, 6, CURRENT_TIMESTAMP - INTERVAL '2 hours 30 minutes'), -- Conectores RJ45 Cat 6 x50
(5, 15, 16, 6, CURRENT_TIMESTAMP - INTERVAL '2 hours'), -- Placas de Pared RJ45 x16
(5, 61, 20, 6, CURRENT_TIMESTAMP - INTERVAL '1 hour 30 minutes'); -- Canaleta Plástica 25x16 - 20m
