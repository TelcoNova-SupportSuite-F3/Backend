...
CREATE TABLE ordenes_trabajo (
    ...
    descripcion TEXT,
    estado estado_orden NOT NULL DEFAULT 'ASIGNADA',
...
BEGIN
    ...
    IF OLD.estado IS DISTINCT FROM NEW.estado THEN
        INSERT INTO historial_estados (
            ...
            COALESCE(NEW.tecnico_asignado_id, 1) -- Usuario por defecto si no hay técnico
        );
    END IF;
...
('admin@telconova.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iYqiSfFdEZinvI4aJ5Zi7.MGzfxO', 'Administrador Sistema', 'ADMIN'), -- password: admin123
('juan.perez@telconova.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iYqiSfFdEZinvI4aJ5Zi7.MGzfxO', 'Juan Pérez González', 'TECNICO'), -- password: admin123
('maria.rodriguez@telconova.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iYqiSfFdEZinvI4aJ5Zi7.MGzfxO', 'María Rodríguez López', 'TECNICO'), -- password: admin123
('carlos.martinez@telconova.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iYqiSfFdEZinvI4aJ5Zi7.MGzfxO', 'Carlos Martínez Silva', 'TECNICO'); -- password: admin123
